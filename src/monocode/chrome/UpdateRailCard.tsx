  ...
  return (
    ...
    >
      <button
        ...
        className="flex w-full items-start gap-2 rounded-lg px-2 py-2 pr-8 text-left hover:bg-mono-accent/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-mono-accent"
      >
      ...
      <button
        ...
        onClick={onDismiss}
        className="absolute right-1 top-1 grid size-6 place-items-center rounded-md text-content/45 hover:bg-content/8 hover:text-content focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-mono-accent"
      >
