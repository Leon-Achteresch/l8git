  ...
  return (
    ...
    >
      <span className="relative">
        ...
        {files > 0 ? (
          <span className="pointer-events-none absolute -top-1.5 -right-2 grid min-h-3.5 min-w-3.5 place-items-center rounded-full bg-mono-accent px-0.5 text-[7px] font-semibold leading-none text-white tabular-nums">
            {badge}
          </span>
        ) : null}
      </span>
    ...
    <div>
      ...
      >
        ...
        <input
          ...
          className="h-5 min-w-0 flex-1 rounded-sm bg-content/10 px-1 text-[14px] leading-none text-content outline-none ring-1 ring-mono-accent"
        />
      </div>
      {showIssue ? (
