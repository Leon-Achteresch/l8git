      ...
      <div className="relative overflow-visible">
        ...
        <div
          ...
          className={`relative z-10 rounded-lg border bg-content/3 ${
            fileDrag
              ? "border-mono-accent/60"
              : "border-content/10 has-focus:border-content/20"
          }`}
        >
          {fileDrag ? (
            <div className="pointer-events-none absolute inset-0 z-20 grid place-items-center rounded-lg bg-mono-accent/8 text-[12px] text-content/70">
