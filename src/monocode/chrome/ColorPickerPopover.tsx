    ...
    <div className="mt-2 rounded-lg border border-content/10 bg-content/5 p-2">
      ...
      <div className="mt-2 flex items-center gap-2">
        ...
        <input
          ...
          className="min-w-0 flex-1 rounded-md border border-content/10 bg-content/5 px-2 py-1 font-mono text-[12px] text-content outline-none ring-mono-accent/40 focus:ring-1"
        />
      </div>
    </div>
  );
