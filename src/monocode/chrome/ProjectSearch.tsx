        ...
        {groups.map((group) => (
          <section key={group.path} className="border-b border-content/8">
            <div className="flex items-center gap-1.5 px-2 py-1.5">
              ...
              <span className="rounded-full bg-mono-accent/20 px-1.5 py-0.5 text-[10px] tabular-nums text-mono-accent">
    ...
    try {
      ...
      return (
        <>
          ...
          <mark className="rounded-sm bg-mono-accent/35 text-content">
