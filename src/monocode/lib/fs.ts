...
export function gitPush(cwd: string): Promise<void> {
  return invoke<void>("mono_git_push", { cwd });
}

export function gitPull(cwd: string): Promise<void> {
  return invoke<void>("mono_git_pull", { cwd });
}
...
export function gitCheckout(
  ...
  return invoke<string>("mono_git_checkout", { cwd, name, remote: remote ?? null });
}

export function gitCreateBranch(cwd: string, name: string): Promise<string> {
  return invoke<string>("mono_git_create_branch", { cwd, name });
}
