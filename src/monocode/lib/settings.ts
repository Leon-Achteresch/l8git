...
export const SETTINGS_SECTIONS: {
  ...
  },
  {
    id: "usage",
    label: "Usage",
    description: "Tokens per session and what they would have cost on the API.",
  },
  {
    id: "sync",
    label: "Sync",
    description: "Copy skills, commands, agents, MCP servers and hooks between CLIs and scopes.",
  },
  {
    id: "marketplace",
    label: "Marketplace",
    description: "Install skills, MCP servers, plugins and hooks from GitHub.",
  },
  {
    id: "archive",
    label: "Archive",
