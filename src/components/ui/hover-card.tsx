      ...
      {isOpen ? (
        ...
        >
          ...
          >
            <m.div
              className={cn(
                "z-[80] w-64 max-w-(--radix-hover-card-content-available-width) rounded-lg bg-popover p-2.5 text-sm text-popover-foreground shadow-md ring-1 ring-foreground/10 outline-hidden",
                className
              )}
              style={{
                transformOrigin:
