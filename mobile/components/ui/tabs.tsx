...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      className={cn(
        'bg-card flex h-10 flex-row items-center justify-center rounded-full p-1',
  ...
  return (
    <TextClassContext.Provider
      ...
      <TabsPrimitive.Trigger
        className={cn(
          'flex h-full flex-row items-center justify-center gap-1.5 rounded-full px-3 py-1',
          Platform.select({
