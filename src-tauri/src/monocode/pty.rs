...
use crate::monocode::fs::expand_home;
...
impl PtyHost {
    ...
    pub(crate) fn kill_all(&self) {
        ...
        crate::monocode::harness::terminate_all(&pids);
    }
}
...
#[tauri::command]
pub fn mono_pty_write(host: State<PtyHost>, id: String, data: String) -> Result<(), String> {
    let live = host
        .get(&id)
...
#[tauri::command]
pub fn mono_pty_resize(host: State<PtyHost>, id: String, cols: u16, rows: u16) -> Result<(), String> {
    let live = host
        .get(&id)
        .ok_or_else(|| "Terminal is not running".to_string())?;
    #[cfg(unix)]
