...
#[tauri::command]
pub async fn mono_git_push(cwd: String) -> Result<(), String> {
...
#[tauri::command]
pub async fn mono_git_pull(cwd: String) -> Result<(), String> {
    tauri::async_runtime::spawn_blocking(move || {
...
#[tauri::command]
pub async fn mono_git_checkout(
    cwd: String,
    name: String,
...
#[tauri::command]
pub async fn mono_git_create_branch(cwd: String, name: String) -> Result<String, String> {
...
fn gh_run(root: &Path, args: &[&str], allow_empty: bool) -> Result<String, String> {
    let program = crate::monocode::harness::resolve_gui_binary("gh")
    ...
    cmd.current_dir(root)
        ...
        .env("GH_PAGER", "cat")
        .env("GIT_PAGER", "cat");
    crate::monocode::harness::apply_gui_env(&mut cmd);
